...
def get_next_token(look_ahead_char, input_file):
    global line_number
...
# symbol table file
def symboltable2file(symbol_table_file):
...
# Tokens file
def token2file(token_type, token_lexime, token_file):
    global token_lineno
...
# Error file
def error2file(error_type, error_string, errors_file):
    global have_error
    have_error = True
    global error_lineno
